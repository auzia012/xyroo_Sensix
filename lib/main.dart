          ...
          child: Column(
            ...
            children: [
              ...
              _SetupCard(
                ...
                title: 'Shizuku',
                subtitle:
                    'Required untuk menjalankan perintah sistem\n(wm density, wm size)',
                status:
                    _shizukuConnected ? 'Connected' : 'Not Connected',
                statusColor: _shizukuConnected
              ...
              const _SetupCard(
                ...
                subtitle:
                    'Diperlukan untuk menampilkan floating window di atas aplikasi lain',
                status: 'Required',
        ...
        child: NavigationBar(
          ...
          destinations: const [
            ...
            NavigationDestination(
              ...
              selectedIcon: Icon(Icons.aspect_ratio_rounded,
                  color: Color(0xFF00F5FF)),
              label: 'Screen',
            ),
            NavigationDestination(
                  ...
                  children: [
                    ...
                    Text(_currentDpi,
                        style: const TextStyle(
                            ...
                            fontWeight: FontWeight.w900,
                            color: Color(0xFF00F5FF))),
                    const Text('wm density',                fontSize: 32,
                fontWeight: FontWeight.w900,
                foreground: Paint()
